...
const createData = () => { //added const to createData and assigned it to the following variables
    // Variables assigned by the createData constant
  ...
  const weeks = [];
    ...
    // weekDay for starting week from Sunday
    let weekDay = firstDay < 6 ? firstDay + 1 : 6;
...
const createHtml = () => {
    ...
    for (let i = 0; i < weeks.length; i++) {
        ...
        const weekNumber = document.createElement('td'); //td represents table data cell
